...
params = {
    ...
    'envelopes': [0.004, 0.006, 0.008],      # ✅ CHANGED (was [0.07,0.11,0.14])
    'stop_loss_pct': 0.012,                  # ✅ CHANGED (was 0.35)
    'price_jump_pct': 0.3,
    ...
    'trend_buffer_pct': 0.003,               # ✅ 0.2% buffer around EMA100 to avoid whipsaws
}
